...
var bio = {
  ...
  "skills": [
    "awesome", "delivering things", "cryogenic sleept", "saving the universe"
  ],
...
onlineClasses.displayClasses = function() {
  $("#education").append(HTMLonlineClasses);

  onlineClasses.onlineClasses.forEach(function(onlineClass) {
    $("#education").append(HTMLschoolStart);
